...
PNG_PATH = OUTPUT_DIR / "hypothesis3.png"
ALPHA = 0.05
...
def main() -> None:
    ...
    analytical_stats = paired_pre_post(normal["Total Analytical Trust"], normal["Total Analytical Trust Post"])
    emotional_stats = paired_pre_post(normal["Total Emotional Trust"], normal["Total Emotional Trust Post"])
    ...
    fig.suptitle("Hypothesis 3: NORMAL (Non-WEIRD) Trust Change Pattern", fontsize=24)
