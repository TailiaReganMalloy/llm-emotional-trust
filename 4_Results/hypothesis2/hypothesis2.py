...
PLOT_OUTPUT_PATH = OUTPUT_DIR / "hypothesis7.png"
REPORT_OUTPUT_PATH = OUTPUT_DIR / "hypothesis7.txt"
ALPHA = 0.05
...
def main() -> None:
    ...
    draw_condition_subplot(
        axes[0],
        overall_test,
        title="7.1 Main Condition Effect: Overall Change",
        ylabel="Overall Change",
    )
    draw_condition_subplot(
        axes[1],
        emotional_test,
        title="7.2 Main Condition Effect: Emotional Change",
        ylabel="Emotional Change",
    )
    draw_condition_subplot(
        axes[2],
        analytical_test,
        title="7.3 Main Condition Effect: Analytical Change",
    ...
    fig.suptitle("Hypothesis 7: Main Condition Effects Across Trust Change Outcomes", fontsize=22)
