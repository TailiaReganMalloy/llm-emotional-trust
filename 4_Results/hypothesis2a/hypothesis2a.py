...
PLOT_OUTPUT_PATH = OUTPUT_DIR / "hypothesis8.png"
REPORT_OUTPUT_PATH = OUTPUT_DIR / "hypothesis8.txt"
ALPHA = 0.05
...
def draw_group_split_subplot(
    ...
    summary = (
        f"WEIRD: t={float(weird_test['t']):.3f}, p {format_p(float(weird_test['p']))}\n"
        f"NORMAL: t={float(normal_test['t']):.3f}, p {format_p(float(normal_test['p']))}"
    )
    ax.text(
        0.01,
        0.99,
...
def main() -> None:
    ...
    draw_group_split_subplot(
        ...
        title="8.1 Main Condition Effect: Overall Change (WEIRD vs NORMAL)",
    ...
    draw_group_split_subplot(
        ...
        title="8.2 Main Condition Effect: Emotional Change (WEIRD vs NORMAL)",
    ...
    draw_group_split_subplot(
        ...
        title="8.3 Main Condition Effect: Analytical Change (WEIRD vs NORMAL)",
    ...
    fig.suptitle("Hypothesis 8: Condition Effects by WEIRD/NORMAL Across Trust Change Outcomes", fontsize=22)
