...
PNG_PATH = OUTPUT_DIR / "mediation.png"
...
def draw_results(results: list[MediationResult]) -> None:
    ...
    axes[0].set_ylabel("Indirect Effect (a*b)")
    fig.suptitle("Mediation Of WEIRD-Defining Attributes On Analytical-Emotional Change Difference", fontsize=18)
